...
\title{Using an MPSoC to implement DNA sequence alignment}
\subtitle{An implementation and acceleration of the Smith-Waterman algorithm}
% \author{naam student}
\forenameA{Robin}
\surnameA{Nollet}
...
\promotorA[Co-supervisors]{Ing. Václav \v{S}imek}
\promotorB[]{Ing. Jonas Lannoo}
\promotorC[Supervisor]{Prof. dr. ir. Davy Pissoort}
