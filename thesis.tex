...
\subtitle{An implementation and acceleration of the Smith-Waterman \newline algorithm}
% \author{naam student}
\forenameA{Robin}
\surnameA{Nollet}
...
\promotorA[Co-promoteren]{Ing. Václav \v{S}imek}
\promotorB[]{Ing. Jonas Lannoo}
\promotorC[Promotor]{Prof. dr. ir. Davy Pissoort}
