...
\begin{enumerate}
	...
	\begin{figure}[H]
		...
		\caption{From left to right is the pictures taken at each iteration in the flowcell. The color at that specific spot marks which nucleotide has been bound. With the use of some image processing techniques the exact sequence in that spot can be identified.\cite{pptHowest}}
		\label{fig:ImProc}
	\end{figure}
