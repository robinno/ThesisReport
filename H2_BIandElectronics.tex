...
In October 1990, biologists in the relatively new field of molecular biology started the Human Genome Project. The goal of this project was to determine the sequence of the 3 billion base pairs that make up the human DNA. This project was succesfully completed in 2003, So nowadays we have a good idea how the human genome is builtup.

The Human Genome is easily found on the internet, since it is publically available. One of the most often used is \emph{HG19}. Since DNA has only 4 possible bases, this can be encoded in a 2 bit representation. If this encoding is used, the Human Genome is approximately 750 megabytes.
